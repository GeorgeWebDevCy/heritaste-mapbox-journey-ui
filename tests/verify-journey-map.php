...
$failures    = array();
$expectations = array(
	'Plugin version constant'      => array( $main, "HERITASTE_MAPBOX_JOURNEY_UI_VERSION', '1.6.13" ),
	...
	'Endpoint proximity grouping'  => array( $javascript, 'Math.abs(candidate.longitude - longitude) <= 5' ),
